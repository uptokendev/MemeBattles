...
ALTER TABLE public.wm_social_link_challenges
  DROP CONSTRAINT IF EXISTS wm_social_link_challenges_provider_valid;

ALTER TABLE public.wm_social_link_challenges
  ADD CONSTRAINT wm_social_link_challenges_provider_valid
