...
CREATE TABLE IF NOT EXISTS lp_pool_registrations (
  chain_id INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS lp_claimable_snapshots (
  chain_id INTEGER NOT NULL,
  pool_address TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS lp_harvests (
  chain_id INTEGER NOT NULL,
  pool_address TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS lp_pending_payments (
  chain_id INTEGER NOT NULL,
  pool_address TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS lp_revenue_routes (
  chain_id INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS creator_registry_events (
  chain_id INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS risk_registry_events (
  chain_id INTEGER NOT NULL,
  registry_address TEXT NOT NULL,
  tx_hash TEXT NOT NULL,
  log_index INTEGER NOT NULL,
...
INSERT OR REPLACE INTO indexer_meta (key, value, updated_at) VALUES ('schemaVersion', '1', strftime('%s','now'));
