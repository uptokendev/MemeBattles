...
CREATE TABLE IF NOT EXISTS public.sponsorship_applications (
  ...
  CONSTRAINT sponsorship_applications_image_url_length CHECK (image_url IS NULL OR char_length(image_url) <= 2000),
...
CREATE TABLE IF NOT EXISTS public.sponsored_placements (
  ...
  CONSTRAINT sponsored_placements_image_url_length CHECK (image_url IS NULL OR char_length(image_url) <= 2000),
