...
export interface MockTopazDriftRouterInterface extends Interface {
  getFunction(
...
export interface MockTopazDriftRouter extends BaseContract {
  connect(runner?: ContractRunner | null): MockTopazDriftRouter;
  waitForDeployment(): Promise<this>;

  interface: MockTopazDriftRouterInterface;
