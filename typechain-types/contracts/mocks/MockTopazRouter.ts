...
export interface MockTopazRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
...
export interface MockTopazRouter extends BaseContract {
  connect(runner?: ContractRunner | null): MockTopazRouter;
  waitForDeployment(): Promise<this>;

  interface: MockTopazRouterInterface;
