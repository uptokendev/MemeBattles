...
```env
VITE_API_BASE_URL=https://YOUR-RAILWAY-API-GATEWAY.up.railway.app
VITE_REALTIME_API_BASE=https://YOUR-RAILWAY-API-GATEWAY.up.railway.app
VITE_ABLY_AUTH_BASE=https://YOUR-RAILWAY-API-GATEWAY.up.railway.app
```
