    ...
    <div className="space-y-6 px-1 pb-10">
      <section className="mwz-hud-frame p-5 md:p-7">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-2 font-retro text-3xl tracking-tight text-foreground md:text-5xl">Season standings, movement, and reward pool context.</h1>
      ...
      <section className="grid gap-4 xl:grid-cols-4">
        <div className="mwz-hud-frame p-4">
          ...
          <div className="mt-1 text-sm text-muted-foreground">{leadEntry ? `${leadEntry.points} pts · ${leadEntry.symbol}` : leagueSource === "empty" ? "League standings are not available on this branch yet." : "Awaiting standings"}</div>
        </div>
        <div className="mwz-hud-frame p-4">
        ...
        <div className="mwz-hud-frame p-4">
          ...
          <div className="mt-1 text-sm text-muted-foreground">Tokens currently marked to move up</div>
        </div>
        <div className="mwz-hud-frame p-4">
          ...
          <div className="mt-1 text-sm text-muted-foreground">Tokens currently marked to move down</div>
        </div>
      </section>
      ...
      <section className="mwz-hud-frame p-5 md:p-6">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-1 font-retro text-2xl text-foreground">Memecoins in contention</h2>
            <p className="mt-2 max-w-2xl text-sm text-muted-foreground">When the live campaign feed is available it appears here, so season seeding and standings can be viewed against the current market lineup.</p>
          </div>
      ...
      <section className="mwz-hud-frame p-5">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <div className="mt-1 font-retro text-xl text-foreground">Current season standings</div>
          </div>
      ...
      <section className="mwz-hud-frame p-5">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <div className="mt-1 font-retro text-xl text-foreground">Completed seasons</div>
          </div>
