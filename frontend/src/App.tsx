    ...
    <div className="mwz-app-shell h-screen overflow-hidden flex flex-col">
      ...
      >
        <Routes>
          ...
          {postGradEnabled && postGradFlags.arena ? <Route path="/arena/battles" element={<ArenaBattles />} /> : null}
          ...
          {postGradEnabled && postGradFlags.arena ? <Route path="/battle/:id" element={<BattleDetails />} /> : null}
