      ...
      <div className="grid min-h-[188px] grid-cols-[140px_minmax(0,1fr)] gap-4 items-center">
        ...
        <div className="flex min-w-0 flex-col justify-between h-full py-1">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <Button className="mwz-button h-10 text-xs" onClick={() => navigate("/create")}>Start a Battle</Button>
            <Button className="mwz-button mwz-button-active h-10 text-xs" onClick={() => navigate("/battle-leagues")}>Go to Leagues</Button>
          </div>
        </div>
      </div>
    </div>
