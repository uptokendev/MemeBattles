        ...
        <Tabs value={tradeTab} onValueChange={(value) => setTradeTab(value as "buy" | "sell")}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
                  <span className="text-xs font-mono text-muted-foreground">{tradeInputDenom === "BNB" ? "BNB" : campaign.symbol}</span>
                </div>
              </div>
              <div className="flex items-center justify-between mt-2">
                <span className="text-xs text-muted-foreground">
                  Balance: {tradeInputDenom === "BNB" ? formatBnbFromWei(bnbBalanceWei) : `${formatTokenFromWei(tokenBalanceWei)} ${campaign.symbol}`}
                </span>
                <span className="text-xs text-muted-foreground">
          ...
          <TabsContent value="sell" className="space-y-3 mt-0">
            <div>
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <span className="text-xs text-muted-foreground">Amount ({tradeInputDenom === "BNB" ? "BNB" : campaign.symbol})</span>
                  <Button
                    variant="ghost"
                    size="sm"
