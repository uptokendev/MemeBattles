...
export const LEAGUES: LeagueDef[] = [
  {
    ...
    ruleSummary: "Monthly only. Campaign must graduate with zero bonding-curve sells.",
  ...
  },
  {
    ...
    ruleSummary: "Fastest creation-to-graduation time. Creator buys are excluded from scoring.",
  ...
  },
  {
    ...
    ruleSummary: "Most confirmed UpVotes from unique voters in the selected epoch.",
  ...
  },
  {
    ...
    supports: ["weekly", "monthly"],
    supportedPeriods: ["weekly", "monthly"],
    metricLabel: "Weighted referral score",
    ruleSummary: "Referral performance across linked wallets, creators, traders, and referred volume.",
